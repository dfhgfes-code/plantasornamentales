          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-3">
              {[
                {
                  name: 'Instagram',
                  url: settings.shop_instagram || '#',
                  bg: 'bg-gradient-to-br from-[#f09433] via-[#e6683c] via-[#dc2743] via-[#cc2366] to-[#bc1888] text-white hover:opacity-90',
                  icon: (
                ...
                {
                  name: 'WhatsApp',
                  url: `https://wa.me/${settings.shop_whatsapp}`,
                ...
                <a
                  ...
                  className={`w-10 h-10 flex items-center justify-center rounded-xl transition-all hover:-translate-y-0.5 hover:shadow-lg ${s.bg}`}
                  aria-label={s.name}
                >
                  {s.icon}
                </a>
