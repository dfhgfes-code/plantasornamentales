            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  className="w-10 h-10 flex items-center justify-center bg-white/5 hover:bg-pink-500/20 border border-white/10 hover:border-pink-500/30 rounded-xl text-white/40 hover:text-white transition-all"
                  aria-label={s.name}
                >
                  {s.icon}
                </a>
