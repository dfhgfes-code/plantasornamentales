  ...
  private getBaseTemplate(title: string, content: string): string {
    return `
      ...
      <head>
        <meta charset="utf-8">
        <style>
          body { font-family: 'Inter', Arial, sans-serif; background-color: #fdfaf7; color: #374151; margin: 0; padding: 0; }
          ...
          .header h1 { margin: 0; font-family: 'Playfair Display', serif; font-size: 28px; font-weight: normal; }
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p style="margin: 5px 0 0; opacity: 0.9; font-size: 14px;">Boutique Floral</p>
          </div>
          <div class="content">
          ...
          <div class="footer">
            © ${new Date().getFullYear()} Janneth Acevedo. Todos los derechos reservados.<br>
  ...
  async sendWelcomeEmail(to: string, name: string) {
    ...
    const content = `
      ...
      <div style="text-align: center;">
        <a href="https://janneth-acevedo-plantas.vercel.app/tienda" class="button">Descubrir Arreglos</a>
      </div>
    `;
